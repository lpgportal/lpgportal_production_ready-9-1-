...
export default function App() {
  ...
  // One-time production data cleanup wiper on mount
  useEffect(() => {
    if (typeof window !== "undefined") {
      const isCleaned = localStorage.getItem("lpgportal_canli_gecis_v6");
      if (!isCleaned) {
        const cleanUsers = [
          {
            id: "user_admin",
        ...
        localStorage.setItem("lpgportal_users", JSON.stringify(cleanUsers));
        localStorage.setItem("lpgportal_invoices", JSON.stringify([]));
        localStorage.setItem("lpgportal_companies", JSON.stringify([]));
        localStorage.setItem("lpgportal_products", JSON.stringify([]));
        localStorage.setItem("lpgportal_orders", JSON.stringify([]));
        localStorage.setItem("lpgportal_news_db", JSON.stringify([]));
        localStorage.setItem("lpgportal_bulletins_db", JSON.stringify([]));
        localStorage.setItem("lpgportal_user_contents_db", JSON.stringify([]));
        localStorage.setItem("lpgportal_writer_notifications", JSON.stringify([]));
        localStorage.setItem("lpgportal_expert_profiles", JSON.stringify([]));
        localStorage.setItem("lpgportal_expert_profiles_db", JSON.stringify([]));
        localStorage.setItem("lpgportal_fault_requests", JSON.stringify([]));
        localStorage.setItem("lpgportal_tech_solutions", JSON.stringify([]));
        localStorage.setItem("lpgportal_contact_requests", JSON.stringify([]));
        localStorage.setItem("lpgportal_notification_logs", JSON.stringify([]));
        localStorage.setItem("lpgportal_sent_sms_logs", JSON.stringify([]));
        localStorage.setItem("lpgportal_sent_email_logs", JSON.stringify([]));
        localStorage.setItem("lpgportal_paytr_transactions", JSON.stringify([]));
        localStorage.setItem("lpgportal_central_notifications", JSON.stringify([]));
        localStorage.setItem("lpgportal_sent_notification_logs", JSON.stringify([]));
        localStorage.setItem("lpgportal_favorites", JSON.stringify([]));
        localStorage.setItem("lpgportal_user_certificates", JSON.stringify([]));
        localStorage.setItem("lpgportal_jobs", JSON.stringify([]));
        localStorage.setItem("lpgportal_videos", JSON.stringify([]));
        localStorage.setItem("lpgportal_questions", JSON.stringify([]));
        localStorage.setItem("lpgportal_podcasts", JSON.stringify([]));
        localStorage.setItem("lpgportal_quote_requests", JSON.stringify([]));
        localStorage.setItem("lpgportal_quote_audit_logs", JSON.stringify([]));
        localStorage.setItem("lpgportal_quote_notifications", JSON.stringify([]));
        localStorage.setItem("lpgportal_used_coupons", JSON.stringify([]));
        localStorage.setItem("lpgportal_manual_notifications", JSON.stringify([]));
        ...
        // Seed reviews
        localStorage.setItem("lpgportal_home_reviews", JSON.stringify([
          {
            id: "rev-seed-1",
            userId: "user_hakan",
            authorName: "Hakan Soylu",
        ...
        localStorage.setItem("lpgportal_canli_gecis_v6", "true");
        
        // Log out active user if they were logged in to force fresh credentials validation
        if (localStorage.getItem("lpgportal_active_user")) {
          localStorage.removeItem("lpgportal_active_user");
          sessionStorage.removeItem("lpgportal_session_id");
